	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<span class="description"><?php _e('Set maximum number of slides to shown. Minimum number of slides to shown will work for Desktop.','sliderspack-all-in-one-image-sliders'); ?></span>
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			...
			<td>
				...
				<span class="description"><?php _e(' Set width of each slide. This setting is required for all horizontal carousels!','sliderspack-all-in-one-image-sliders'); ?></span>
			</td>
		</tr>
		<tr>
			<th>
