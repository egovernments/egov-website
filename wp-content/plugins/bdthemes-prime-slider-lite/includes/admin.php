...
class Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style(
            'bdt-uikit',
            BDTPS_ASSETS_URL . 'css/bdt-uikit' . $suffix . '.css',
            [],
            '3.2'
        );
        wp_enqueue_style(
            'bdthemes-prime-slider-admin',
            BDTPS_ASSETS_URL . 'css/admin' . $suffix . '.css',
            [],
            BDTPS_VER
        );
        wp_enqueue_style(
            'prime-slider-font',
            BDTPS_ASSETS_URL . 'css/prime-slider-font' . $suffix . '.css',
            [],
            BDTPS_VER
        );
        // javascript enqueue
        wp_enqueue_script(
            'bdt-uikit',
            BDTPS_ASSETS_URL . 'js/bdt-uikit.js',
            [ 'jquery' ],
            BDTPS_VER
        );
    }
    ...
    public function admin_script()
    {
        ...
        if ( is_admin() ) {
            ...
            wp_enqueue_script(
                'prime-slider-admin-script',
                BDTPS_ASSETS_URL . 'js/prime-slider-admin' . $suffix . '.js',
                [ 'jquery' ],
                BDTPS_VER,
                true
            );
