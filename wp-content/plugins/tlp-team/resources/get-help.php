		...
		<div class="tlp-team-setting-container">
			...
			<div id="support" class="rt-document-box">
				...
				<div class="rt-box-content">
					...
					<iframe width="800" height="450" src="https://www.youtube.com/embed/xwfF321c6Sc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			...
			<div class="rtteam-call-to-action" style="background-image: url('<?php echo esc_url( rttlp_team()->assets_url() ); ?>/images/admin/banner.png')">
				<a href="https://www.radiustheme.com/downloads/tlp-team-pro-for-wordpress/" target="_blank" class="rt-update-pro-btn">
			...
			<div class="doc-section" style="margin-bottom: 20px;">
				...
				<div class="rt-document-box">
					...
					<div class="rt-box-content">
						...
						<a href="https://www.radiustheme.com/ticket-support/">ticket here</a> or post on <a href="https://www.facebook.com/groups/234799147426640/">facebook group</a>. For emergency case join our <a href="https://www.radiustheme.com/">live chat</a>.</p>
						<a href="https://www.radiustheme.com/ticket-support/" target="_blank" class="rt-admin-btn">Get Support</a>
					</div>
				</div>
				<div class="rt-document-box">
					...
					<div class="rt-box-content">
						...
						<a href="https://wordpress.org/support/plugin/tlp-team/reviews/?filter=5#new-post" class="rt-admin-btn" target="_blank">Post Review</a>
					</div>
				</div>
			</div>
