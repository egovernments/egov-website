...
class SmartPopup {
	...
	protected function init() {
		add_action( 'wp_ajax_tlp_team_smart_popup', array( $this, 'response' ) );
		add_action( 'wp_ajax_nopriv_tlp_team_smart_popup', array( $this, 'response' ) );
	}
