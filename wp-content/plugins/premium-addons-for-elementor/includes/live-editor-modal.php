...
<div class="premium-live-editor-iframe-modal">
	<div class="dialog-widget dialog-lightbox-widget dialog-type-buttons dialog-type-lightbox elementor-templates-modal pa-dynamic-content-modal" id="elementor-template-pa-live-editor-modal-container" style="display:none">
					...
					<div class="elementor-templates-modal__header__logo-area">
						<div class="elementor-templates-modal__header__logo">
							...
							<div class="premium-live-editor-title">
								...
								<span class="pa-live-temp-notice" ><?php esc_html_e( '(Make sure to click update button first)', 'premium-addons-for-elementor' ); ?></span>
							</div>
						</div>
					</div>
