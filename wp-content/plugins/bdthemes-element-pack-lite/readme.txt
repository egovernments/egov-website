...
Element Pack Addon for [Elementor](https://wordpress.org/plugins/elementor/) Page Builder is the ultimate web solution and the number #1 addon with essential web development tools for WordPress. Element Pack provides more than 40 essential elements for everyday applications to simplify the whole web building process.
...
0. [Brand Carousel](https://elementpack.pro/demo/element/dynamic-carousel/) - The brand carousel widget is the perfect branding assistant for WordPress that lets you display brand images having a hover popup animation window over the background. See the demo
