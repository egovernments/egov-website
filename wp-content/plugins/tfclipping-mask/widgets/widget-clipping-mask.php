	    ...
	    // Start Clipping Mask        
		    ...
		    $this->add_control(
			    ...
			    [
				    ...
				    'selectors' => [
					    '{{WRAPPER}} .tf-clipping-mask .image-clipping-mask' => 'mask-image: url( '.URL_PLUGIN_CLIPPING_MASK.'assets/img/{{value}}.svg ); -webkit-mask-image: url( '.URL_PLUGIN_CLIPPING_MASK.'assets/img/{{value}}.svg );',
				    ]
			    ]
		    );
